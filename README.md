...
```bash
curl -sL https://raw.githubusercontent.com/yaog6700-bit/nowhere/main/install.sh | bash
```
...
```bash
bash <(curl -sL https://raw.githubusercontent.com/yaog6700-bit/nowhere/main/install.sh) uninstall
```
